...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.rows = QtWidgets.QLineEdit(Dialog)
        self.rows.setGeometry(QtCore.QRect(130, 40, 300, 20))
        self.rows.setStyleSheet("font-size: 16px;\n"
...
"font: 16pt \"Franklin Gothic Demi\";")
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label_3.setText(_translate("Dialog", "Введите кол-во отображаемых строк"))
